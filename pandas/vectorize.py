...
if __name__ == "__main__":
    ...
    RUN_NAME = f"{ACCELARATOR[-1]}-{IMAGE_SIZE}-heirarchical-resnet50+L1-{PERCENT_SAMPLING}-{BATCH_SIZE}-inner_iteration={INNER_ITERATION}_patch=stride={PATCH_SIZE}-linear_warmup={WARMUP_EPOCHS}-18GB"
